  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto">
        ...
        >
          Trabajemos <span className="text-gradient-blue">Juntos</span>
        </h2>
          ...
          <div ref={infoRef} className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8 space-y-8 flex flex-col h-full">
            ...
            <div className="border-t border-white/10 pt-6 mt-auto">
              <div className="flex items-center gap-3 mb-3">
                ...
                <p className="font-semibold">Disponible para proyectos</p>
              </div>
              <p className="text-gray-400 text-sm">
                Respondo en menos de 24 horas. Cuéntame sobre tu proyecto y trabajemos juntos.
              </p>
            </div>
          </div>
      ...
      <div className="max-w-6xl mx-auto mt-12 pt-6 border-t border-white/10">
        <p className="text-center text-gray-500 text-sm">
          © 2025 Denis. Todos los derechos reservados.
        </p>
      </div>
    </section>
  );
